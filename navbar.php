            ...
            <div class="navbar-nav">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                        <a class="dropdown-item" href="./konzole/gameBoy.php">Game Boy</a>
                        <a class="dropdown-item" href="./konzole/gameBoyColor.php">Game Boy Colour</a>
                        <a class="dropdown-item" href="./konzole/gameBoyAdvanced.php">Game Boy Advance</a>
                        <a class="dropdown-item" href="./konzole/nintendoDS1.php">Nintendo DS (4. Generacija)</a>
                        <a class="dropdown-item" href="./konzole/nintendoDS2.php">Nintendo DS (5. Generacija)</a>
                        <a class="dropdown-item" href="./konzole/nintendo3DS1.php">Nintendo 3DS (6. generacija)</a>
                        <a class="dropdown-item" href="./konzole/nintendo3DS2.php">Nintendo 3DS (7. generacija)</a>
                        <a class="dropdown-item" href="./konzole/nintendoSwitch.php">Nintendo Switch (8. generacija)</a>
                        <a class="dropdown-item" href="./konzole/nintendoSwitch2.php">Nintendo Switch (9. generacija)</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="nav-item dropdown dropstart" id="korisnikLogged">
                        ...
                        <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            ...
                            <?php if ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'owner') { ?>
                                ...
                                <a href="./dashboard/dashboard.php" class="dropdown-item" target="_blank">Dashboard</a>
                                <div class="dropdown-divider"></div>
                            <?php } ?>
